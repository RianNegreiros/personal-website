...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  return {
    ...
    description: postData.data.summary.length > 155 ? postData.data.summary.substring(0, 155) + "..." : postData.data.summary,
    keywords: [...postData.data.title.split(" "), ...postData.data.summary.split(" ").slice(0, 5)],
    openGraph: {
