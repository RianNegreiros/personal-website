...
export default function FloatingButtons() {
  ...
  return (
    ...
    >
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-dracula-pink-400 hover:text-dracula-pink-600">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
          className="w-8 h-8 text-dracula-pink-400 hover:text-dracula-pink-600" viewBox="0 0 1024 1024">
      ...
      >
        <svg
          ...
          fill="currentColor"
          className="w-8 h-8 text-dracula-pink-400 hover:text-dracula-pink-600"
        >
