...
export default function TermsOfService() {
  return (
    <div>
      ...
      <ol>
        <li><span style={{ color: 'rgb(68, 68, 68)' }}>Os materiais no site da Rian Negreiros Dos Santos website são fornecidos 'como estão'. Rian Negreiros Dos Santos website não oferece garantias, expressas ou implícitas, e, por este meio, isenta e nega todas as outras garantias, incluindo, sem limitação, garantias implícitas ou condições de comercialização, adequação a um fim específico ou não violação de propriedade intelectual ou outra violação de direitos.</span></li>
        <li><span style={{ color: 'rgb(68, 68, 68)' }}>Além disso, o Rian Negreiros Dos Santos website não garante ou faz qualquer representação relativa à precisão, aos resultados prováveis ​​ou à confiabilidade do uso dos materiais em seu site ou de outra forma relacionado a esses materiais ou em sites vinculados a este site.</span></li>
      </ol>
