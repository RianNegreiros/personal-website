...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-2xl mx-auto my-8">
      <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-100">Política Privacidade</h2>
      <p className="text-gray-800 dark:text-gray-100 mb-4">
        ...
        <Link href="https://riannegreiros.dev" className="text-blue-500">Rian Negreiros Dos Santos website</Link>, e outros sites que possuímos e operamos.
      </p>
      <p className="text-gray-800 dark:text-gray-100 mb-4">
      ...
      <p className="text-gray-800 dark:text-gray-100 mb-4">
        O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente de que não temos controle sobre o conteúdo e práticas desses sites e não podemos aceitar responsabilidade por suas respectivas <Link href="https://politicaprivacidade.com/" rel="noopener noreferrer" target="_blank" className="text-blue-500">políticas de privacidade</Link>.
      </p>
      <p className="text-gray-800 dark:text-gray-100 mb-4">
      ...
      <ul className="list-disc pl-6 mb-4">
        ...
        <li className="text-gray-800 dark:text-gray-100">
          <span>Vários parceiros anunciam em nosso nome e os cookies de rastreamento de afiliados simplesmente nos permitem ver se nossos clientes acessaram o site através de um dos sites de nossos parceiros, para que possamos creditá-los adequadamente e, quando aplicável, permitir que nossos parceiros afiliados ofereçam qualquer promoção que pode fornecê-lo para fazer uma compra.</span>
        </li>
      </ul>
      <h3 className="text-xl font-bold mb-2 text-gray-800 dark:text-gray-100">Compromisso do Usuário</h3>
      <p className="text-gray-800 dark:text-gray-100 mb-4">
        O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Rian Negreiros Dos Santos website oferece no site e com caráter enunciativo, mas não limitativo:
      </p>
      <ul className="list-disc pl-6 mb-4">
        <li className="text-gray-800 dark:text-gray-100">
        ...
        <li className="text-gray-800 dark:text-gray-100">
          <span>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Rian Negreiros Dos Santos website, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</span>
        </li>
      </ul>
      <h3 className="text-xl font-bold mb-2 text-gray-800 dark:text-gray-100">Mais informações</h3>
      <p className="text-gray-800 dark:text-gray-100 mb-4">
