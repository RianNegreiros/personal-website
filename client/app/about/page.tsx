  ...
  return (
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      ...
      <div className="flex justify-center space-x-5 pt-6">
        <a href="https://github.com/RianNegreiros" target="_blank">
          <svg
        ...
        <a href="https://www.linkedin.com/in/riannegreiros/" target="_blank">
          <svg
            viewBox="0 0 1024 1024"
            fill="currentColor"
            className="w-8 h-8 text-teal-500 hover:text-teal-600"
        ...
        <a href="mailto: riannegreiros@gmail.com" target="_blank">
          <svg
            viewBox="0 0 1024 1024"
            fill="currentColor"
            className="w-8 h-8 text-teal-500 hover:text-teal-600"
